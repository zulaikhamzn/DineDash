...
<<<<<<< HEAD
            user = request.userimport logging
...
file_handler = logging.FileHandler('dinedashapp.log')
...
def log_in_question(request):
    logger.info('Log in question page accessed')
...
class RegularLogInView(FormView):
    ...
    def form_valid(self, form):
        logger.info('Regular customer logged in')
...
class RestaurantLogInView(RegularLogInView):
    ...
    def form_valid(self, form):
        logger.info('Restaurant logged in')
        login(self.request, form.user)
...
class RegularRegistrationView(FormView):
    ...
    def form_valid(self, form):
        logger.info('Regular customer registered')
        form.save()
...
class RestaurantSearchView(ListView):
    ...
    def get_context_data(self, **kwargs):
        logger.info('Restaurant search page accessed')
...
class RestaurantInfoView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        logger.info('Restaurant info page accessed')
...
class EditRestaurantInfoView(UpdateView):
    ...
    def get_form(self, form_class=None):
        logger.info('Restaurant info edited')
...
>>>>>>> 181d2b129489ae1bc21f355403aa8567c2e825e3
